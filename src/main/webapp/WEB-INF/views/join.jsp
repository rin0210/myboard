    ...
    <div id="preloader">
        ...
        <div class="questions-area text-center">
            ...
            <ul>
                ...
                <li>The worldâs largest photo album by dimensions was 13 ft 11.5 in x 17 ft.</li>
                <li>The worldâs largest photo mosaic featured 176,175 pictures.</li>
                <li>The worldâs largest camera lens was a 5200mm lens attached to a canon.</li>
            </ul>
        </div>
    </div>
                ...
                <div class="col-12 h-100">
                    <div class="main-menu h-100">
                        <nav class="navbar h-100 navbar-expand-lg">
                            <!-- Logo Area  -->
                            <a class="navbar-brand logo-style" href="javascript:;">YOU and I</a>
        ...
        <div class="container">
            <div class="login">
                <aside class="single_sidebar_widget newsletter_widget">
                    <h4 class="widget_title">SIGN UP</h4>
                    <form action="joinProcess" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Id'" placeholder="Enter Id" required="" name="id">
                            <input type="text" class="form-control" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Name'" placeholder="Enter Name" required="" name="name">
                            <input type="password" class="form-control" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Password'" placeholder="Enter Password" required="" name="pwd">
                        </div>
                        <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn studio-btn btn-login" type="submit">SIGN UP</button>
                    </form>
                </aside>
            </div>
        </div>
                ...
                <div class="col-12 h-100">
                    <div class="footer-content h-100 d-md-flex align-items-center justify-content-between">
                        ...
                        <div class="single-footer-content">
                            ...
                            <a href="#">Blvd Libertad, 34 m05200 ArÃ©valo</a>
                        </div>
                        <!-- Single Footer Content -->
                        <div class="single-footer-content">
