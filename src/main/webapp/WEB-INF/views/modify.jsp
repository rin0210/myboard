	...
	<section class="blog-area section_padding_100 mt-100">
		<div class="container">
			...
			<div class="comment-form">
				...
				<form class="form-contact comment_form" action="modProcess" id="commentForm" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col-12">
							<div class="form-group">
								<input class="form-control" name="title" id="title" type="text"
									placeholder="Title" required="" value=${detail.title }>
							</div>
						</div>
						<div class="col-12">
							<div class="form-group">
								<textarea class="form-control w-100" name="content" id="content"
									cols="30" rows="10" placeholder="Write Content" required=""
						...
						<div class="col-sm-6">
							<div class="form-group">
								<input class="form-control" name="name" id="name" type="text"
									placeholder="Name" readOnly value=${detail.name }>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<input class="form-control" name="imgfile" id="imgfile"
									type="file" placeholder="imgfile" required="">
								<input type="hidden" name="no" value=${detail.no }>
								<input type="hidden" name="mod_f_no" value=${img.f_no }>
							</div>
						</div>
					</div>
					<div class="form-group">
						<button type="submit"
							class="button button-contactForm btn_1 boxed-btn btn studio-btn btn-write">MODIFY</button>
					</div>
				</form>
			</div>
