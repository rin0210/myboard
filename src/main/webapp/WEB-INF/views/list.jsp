...
<body>
	...
	<!-- Header Area Start -->
	<header class="header-area bg-img" style="background-image:">
		...
		<div class="container-fluid clearfix">
			<!--<div class="gallery_menu">
                <div class="portfolio-menu">
                    ...
                    <button class="btn active" type="button" data-filter=".portraits">Portraits</button>
			...
			<div class="top-write">
				<a href="boardwrite" class="btn studio-btn wirte-btn"> <img
					src="${pageContext.request.contextPath}/resources/img/core-img/logo-icon.png"
					alt=""> Write
				</a>
			</div>
			...
			<div class="row portfolio-column">
				...
				<c:forEach var="list" items="${list }">
					<c:forEach var="img" items="${img }">
						<div
							class="col-12 col-sm-6 col-md-4 col-lg-3 column_single_gallery_item portraits life">
							<c:if test="${list.no == img.b_no}">
								<a href="boarddetail?no=${list.no }"><img src="/img/user-img/${img.stored_name}" alt=""></a>
							</c:if>
							<!-- <div class="hover_overlay">
						<a class="gallery_img"
							href="${pageContext.request.contextPath}/resources/img/user-img/${img.stored_name}"><i
							class="fa fa-eye"></i></a>
					</div> -->
						</div>
					</c:forEach>
					...
					<div
						...
						<div class="single-footer-content">
							<img
								...
								alt=""> <a href="#">Blvd Libertad, 34 m05200 Arévalo</a>
						</div>
						<!-- Single Footer Content -->
						<div class="single-footer-content">
							<img
