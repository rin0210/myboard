        ...
        <div class="container">
            <div class="login">
                <aside class="single_sidebar_widget newsletter_widget">
                    <h4 class="widget_title">SIGN IN</h4>
                    <form action="loginPro" method="post">
                        ...
                        <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn studio-btn btn-login" type="submit">SIGN IN</button>
                        <button class="button rounded-0 primary-bg text-white w-100 btn_1 boxed-btn studio-btn btn-login btn-join" type="button" onclick="location.href='boardjoin'">SIGN UP</button>
                    </form>
                </aside>
            </div>
        </div>
